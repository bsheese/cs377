...
### The 18_6 series uses the Wisconsin Breast Cancer dataset instead of the Ames Housing dataset used in the earlier tree-based notebook (17_2_2). Why is this a meaningful change?
...
### Why does the notebook recommend reviewing notebook 17_2_2 (regression trees) before starting 18_6?
- [ ] Because 17_2_2 covers the same dataset and provides the data cleaning steps needed for 18_6
- [x] Because 17_2_2 introduced tree-based methods that 18_6 builds upon with deeper analysis
- [ ] Because 17_2_2 covers the mathematical proofs behind ensemble methods
- [ ] Because 17_2_2 contains the code for BART that is used in 18_6
...
- [x] The series progresses from understanding the limitations of a single tree (18_6_1), to fixing those limitations through parallel ensembles like bagging and Random Forests (18_6_2), to exploring sequential ensembles like boosting that reduce bias (18_6_3), and finally to rigorously comparing all methods using nested cross-validation to make an evidence-based model selection (18_6_4)
...
### If you were to extend this analysis beyond the four models compared in the nested CV, which additional model from the 18_6 series would you most want to include and why?
- [x] AdaBoost, because it achieved the highest mean accuracy in the 10-fold CV comparison in notebook 18_6_3, and including it in the nested CV would provide an unbiased comparison of whether its high accuracy translates to an unbiased estimate
